...
public class Office2PDF {
    ...
    public static void main(String[] args) {
        ...
        office2pdf.openOfficeToPDF("e:/测试." + OFFICE_DOCX, "e:/测试_" + new Date().getTime() + "." + OFFICE_TO_PDF);
        office2pdf.openOfficeToPDF("e:/测试." + OFFICE_PPTX, null);
    }

    /**
     * 使Office2003-2007全部格式的文档(.doc|.docx|.xls|.xlsx|.ppt|.pptx) 转化为pdf文件<br>
     *
     * @param inputFilePath  源文件路径，如："e:/测试.docx"
     * @param outputFilePath 目标文件路径，如："e:/测试_docx.pdf"
     * @return
     */
     ...
     * 如我的OpenOffice.org 3安装在：C:/Program Files (x86)/OpenOffice 4<br>
     *
     * @return OpenOffice 4.1.3的安装目录
     */
    ...
    /**
     * 获取inputFilePath的后缀名，如："e:/测试.pptx"的后缀名为："pptx"<br>
     *
     * @param inputFilePath
     * @return
     */
